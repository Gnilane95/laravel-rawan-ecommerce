        ...
        <x-nav-femmes/>
            <div class="py-36 xl:mx-48 md:px-14 lg:px-8 sm:px-10">
                <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 lg:gap-10 sm:gap-7">
                    @forelse ($pantalonJeans as $pantalonJean)
                        <a href="">
                            <x-cards.card-vetFemme
                                :url_img="$pantalonJean->url_img" 
                                :category="$pantalonJean->category" 
                                :name="$pantalonJean->name" 
                                :regular_price="$pantalonJean->regular_price" 
                                :sale="$pantalonJean->sale"
                            />
                        </a>
                    @empty
                        <p>Stock épuisé</p>
