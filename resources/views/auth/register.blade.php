<x-guest-layout>
    <x-auth-card>
        ...
        <h1 class="uppercase text-center pt-5 pb-10 text-xl font-black">Nouveau client</h1>
        <form method="POST" action="{{ route('register') }}" class="form-control">
            ...
            <div class="md:flex items-center justify-between mt-4">
                <a class="underline text-md font-bold text-gray-800 hover:text-gray-900" href="{{ route('login') }}">
                    {{ __('Déjà un client ?') }}
                </a>
